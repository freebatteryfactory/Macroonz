...
pub(crate) fn prove_resource_job(evidence_dir: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    fs::write(
        ...
        concat!(
            ...
            "      try { p.Kill(); } catch {}\r\n",
            "      CloseHandle(job);\r\n",
            "      return \"unavailable\\tAssignProcessToJobObject failed; win32=\" + err;\r\n",
            "    }\r\n",
            "    p.WaitForExit(15000);\r\n",
            ...
            "    CloseHandle(job);\r\n",
            "    if (!exited) return \"unavailable\\tchild did not exit under Job Object memory limit\";\r\n",
            "    if (code == 0) return \"unavailable\\tchild exited 0; not evidence of Job Object memory limit\";\r\n",
            "    return \"available\\tchild exited under 8MiB Job Object process-memory limit after successful AssignProcessToJobObject; exit=\" + code;\r\n",
            "  }\r\n",
            "}\r\n",
            "\"@\r\n",
            "$fact = [JobWitness]::Run()\r\n",
