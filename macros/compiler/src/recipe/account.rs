...
use super::{
    ...
    RecipeRelationPayload, RecipeRelationPayloadKind, RecipeRelationRow, RecipeRole,
    RecipeTransitionEffect, RecipeVocabularyParts, RelationLowering, VOCABULARY_LIMIT,
};
...
fn restore_relation_references(tree: &GeneratedTree, relation: &RecipeRelation) -> GeneratedTree {
...
fn restore_projection_references(
    tree: &GeneratedTree,
