...
![Kind vocabulary and complete accounting][diagram-macros-compiler-kind]

Diagram source: `assets/diagrams/macros-compiler-kind.mmd` in this crate's source package.

[diagram-macros-compiler-kind]: ../../assets/diagrams/macros-compiler-kind.svg
