//! What a plan hangs off, what it therefore watches, and where its captured content stands in the origin graph.
//!
...
use super::{
    CauseAnchoring, ContentAddressing, InvalidationSet, InvalidationTrigger, OwnerContentAccount,
    ProjectionContext, ProjectionKind,
};
...
impl CauseAnchoring {
    ...
    ///
    /// A plan hangs off the captured declaration its content walked in with.
    ///
...
impl ProjectionContext {
    ...
    ///
    /// It is a set, and exact duplicates are removed before construction.
