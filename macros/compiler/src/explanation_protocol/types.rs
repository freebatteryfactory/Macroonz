...
use crate::plane::{
    ...
    ProjectionProvenance, RenderedRole, RepairLimit,
};
use crate::planning::{
    CauseAnchoring, InvalidationSet, PlannedOutput, ProjectionDisposition, ProjectionKind,
};
...
crate::plane::limits! {
    ...
    /// # Bounds
    ///
    /// Twelve, the question roster's own cardinality, because a view holds one answered seat per question and a question is answered at most once.
    ExplanationSeatLimit = 12,
    /// The magnitude governing how many issues one explanation-coverage refusal
    /// body may carry.
    ///
    /// # Bounds
    ///
    /// Twelve, because each of the twelve questions can establish at most one coverage issue.
    ///
    /// # Nonclaims
    ///
...
pub enum ExplanationAnswer {
    ...
    /// Which profile you were decided under.
    Profile {
        /// The profile.
