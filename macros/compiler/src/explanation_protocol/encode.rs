...
//!
//! Nothing here invents a canonical form for a value another home owns.
//! A cause anchoring, a planned output, an invalidation trigger, a projection disposition, and an owner-fact citation are all written through the road their own home declares, so an explanation's preimage and a plan's cannot part company about what one of those values is.
//!
//! # Ordering
//!
