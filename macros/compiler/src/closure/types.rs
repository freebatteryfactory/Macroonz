...
///
/// This is what makes the destination vocabulary load-bearing.
/// A single joined tree would hand every rendered unit to the consumer's normal build whatever its plan said about it.
/// The generated mutation module cannot reach the declaration-site seat because its role's constant destination answer reads to the test carrier, and that reading is the only road into a seat.
///
/// # Bounds
///
