...
![Bounded collection construction][diagram-macros-compiler-bounded]

Diagram source: `assets/diagrams/macros-compiler-bounded.mmd` in this crate's source package.

[diagram-macros-compiler-bounded]: ../../assets/diagrams/macros-compiler-bounded.svg
...
This home owns cardinality shape, retained order, caller-key uniqueness, exact denominator assignment, capping posture, and construction refusals.
The [`relation`](crate::relation) home composes these informed collection values into checked rows and structural relation questions without duplicating them.
