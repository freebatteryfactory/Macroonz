...
use crate::planning::{RefusalFamilyImplementationProjection, RenderedImplementation};
use macroonz::Bounded;

use super::plan::refusal_family_implementation_kind;
...
> {
    ...
    ProjectionExplanationView::<RefusalFamilyImplementationProjection>::complete(
        plan,
        closure,
...
fn seats(
    ...
    vec![
        ProjectionExplanation::answered(ExplanationAnswer::Kind {
            kind: refusal_family_implementation_kind(),
        }),
        ...
        ProjectionExplanation::answered(ExplanationAnswer::RelatedProjectionDisposition {
            related: refusal_family_implementation_kind(),
