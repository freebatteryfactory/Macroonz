//! The origin-graph home's declarations: the settled relations an edge may
//! stand for, the edges and the trail they walk, what the plane decided and on
//! whose fact, and what a plan leaves unclaimed.
//!
//! Declarations only. Every road that reaches a private field — the trail's
//! edges, the trace's entries — lives in `type_guard.rs`, this file's own child.
