...
contradiction stands between, the closed issue set, and the family body. No seat
is private — a refusal body a caller cannot read is a refusal nobody can act on —
so this home has no invariant nucleus and no `type_guard.rs` exists to hold one.
