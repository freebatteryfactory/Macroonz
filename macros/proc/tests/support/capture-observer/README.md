...
Its generation observers offer caller-supplied literal values through public token variants and record either the typed admission refusal or the spelling after real proc emission.
...
Publishing it would add no consumer capability because its questions concern normalization, lexical admission and token custody at the real proc-token boundary.
