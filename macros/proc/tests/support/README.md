...
Child commands remove the inherited `NEXTEST_PROFILE` because its name belongs to the parent's workspace configuration, while Cargo job and incremental bounds continue to inherit.
