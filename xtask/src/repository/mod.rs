...
//! [`cargo`] for Cargo's syntax and for what cargo normalizes those manifests
//! to, [`markdown`] for document structure, [`rust`] for Rust syntax.
//! [`snapshot`] is the one place that touches the filesystem or starts a
//! process; [`types`] is the vocabulary the readings and the laws share.
//!
