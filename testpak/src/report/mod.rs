...
pub use types::{
    ...
    NoBaselineReason, NotComparedReason, NotSelectedReason, OutcomeClass, ProfiledTrial,
    REPLAY_CAPSULE_TAG, ROW_REVISION_TAG, RecordedDuration, ReplayCapsule, ReplayPosture,
    ReportComparison, ReportDiff, RowRevisionChange, RowRevisionId, RunAttempt, RunReport,
    SelectionDisposition, SelectionExpectation, SelectionOutcome, SkipReason, SubjectRevisionId,
