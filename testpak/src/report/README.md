...
stated over is the descriptor table itself, so nothing here keeps a second
census of what was owed.
...
the parity subset — records the machine consumes before trusting an optimized
component — and those are designed as exports from the start.
