//! Every narrow visibility arm refuses a wider same-coordinate signature.
...
pub mod shallow_ancestor {
    pub mod owner {
        ...
        pub(crate) fn wider_private(_: private_guard::PrivateGuard) {}
        pub(crate) fn wider_self(_: self_guard::SelfGuard) {}
        pub(crate) fn wider_in_self(_: in_self_guard::InSelfGuard) {}
        pub(crate) fn wider_super(_: super_guard::SuperGuard) {}
        pub(crate) fn wider_in_super(_: in_super_guard::InSuperGuard) {}
        pub fn wider_relative(_: relative_guard::RelativeGuard) {}
        pub fn wider_crate(_: crate_guard::CrateGuard) {}
        pub fn wider_in_crate(_: in_crate_guard::InCrateGuard) {}
        pub(crate) fn wider_absolute(_: absolute_guard::AbsoluteGuard) {}
        pub(crate) fn wider_dollar(_: dollar_guard::DollarGuard) {}
    }
}
...
pub mod deep {
    pub mod ancestor {
        pub mod owner {
            ...
            pub(crate) fn wider_super(_: super_guard::SuperGuard) {}
            pub(crate) fn wider_in_super(_: in_super_guard::InSuperGuard) {}
            pub(crate) fn wider_relative(_: relative_guard::RelativeGuard) {}
            pub fn wider_crate(_: crate_guard::CrateGuard) {}
            pub fn wider_in_crate(_: in_crate_guard::InCrateGuard) {}
            pub(crate) fn wider_absolute(_: absolute_guard::AbsoluteGuard) {}
            pub(crate) fn wider_dollar(_: dollar_guard::DollarGuard) {}
