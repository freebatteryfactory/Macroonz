...
//!
//! Production and evaluation remain separate call paths. The no-mutation posture and active selections exist only on the evaluation copy, so adding a directive to ordinary production is not expressible through this API.
