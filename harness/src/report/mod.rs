...
pub use types::{
    ...
    InvocationProfile, MinimizationProfile, NoBaselineReason, NotComparedReason, NotSelectedReason,
    OutcomeClass, ProfiledTrial, REPLAY_CAPSULE_TAG, ROW_REVISION_TAG, ReplayCapsule,
    ReplayPosture, ReportComparison, ReportDiff, RowRevisionChange, RowRevisionId, RunAttempt,
    ...
    ToolchainIdentity, TrialAccounting, TrialConclusion, TrialFinding, TrialId, TrialProfile,
    TrialReport, TrialRunStanding, TrialSite, Truncation,
};
