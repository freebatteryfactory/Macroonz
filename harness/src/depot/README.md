...
Everything here is a fact about the harness itself.
Product taxonomies, populations, vectors, and other authored facts remain with the product that owns them and enter the harness as declared input.

Runtime evidence never edits an authored bank.
A proposed fact is not an admitted fact, a type-separation row is not a compiler refusal, and a mutation survivor is evidence about a witness rather than authority to grow the operator taxonomy.
