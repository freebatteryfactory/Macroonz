//! The lowering roads: from a producer's discovered sites through owner admission to the executable surface, its selections, and the directive an evaluation call reads.
