...
| `fuzz/` | Macroonz campaign shell around a selected coverage backend: declared preflight facts, named ceilings, interesting-byte handoff into reduction and replay. |
