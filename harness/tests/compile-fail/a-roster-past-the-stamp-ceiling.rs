...
//! sentence.
//!
//! The stamp writes its supply of positions out as literals in one arm and pairs each row of a declaration with exactly one of them. That supply makes the ceiling a statement rather than an accident, and its length is read as `macroonz::CLOSED_REGISTER_ROW_CEILING`.
//!
