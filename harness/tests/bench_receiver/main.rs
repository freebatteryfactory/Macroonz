...
use macroonz_harness::descriptor::{NameRefusal, Provenance};
...
const OWNER: &str = "harness.bench.receiver";
...
fn first_reading(report: &BenchReport) -> Result<&BenchReading, BenchRoadFailure> {
    report
        .readings()
        .first()
