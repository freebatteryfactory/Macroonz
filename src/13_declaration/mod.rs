...
//!
//! # This home consumes the root's closed-register stamp
//!
...
//! repository instantiates — the services crate stamps its rosters with it —
...
//! one consumer among several and reaches for the stamp exactly where every
//! other consumer does.
