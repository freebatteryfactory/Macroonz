...
home: 09_time
obligations:
  - id: time.tick-is-the-clock-observation
    challenge_kind: compile-law
    green: laws.rs time::tick_is_the_clock_observation
    red: owed-to-testpak
  - id: time.observations-are-intervals
    challenge_kind: compile-law
    green: laws.rs time::observations_are_intervals
    red: owed-to-testpak
  - id: time.duration-limit-ladder-and-zero-lawful
    challenge_kind: compile-law
    green: laws.rs time::duration_limit_ladder_and_zero_lawful
    red: owed-to-testpak
  - id: time.deadline-policy-ladder-and-opaque-posture
    challenge_kind: compile-law
    green: laws.rs time::deadline_policy_ladder_and_opaque_posture
    red: owed-to-testpak
  - id: time.chronology-merge-is-a-lawful-join
    challenge_kind: compile-law
    green: laws.rs time::chronology_merge_is_a_lawful_join
    red: owed-to-testpak
  - id: time.hlc-roles-do-not-unify
  ...
  - id: time.spend-uses-the-dimension-register
    ...
    red: owed-to-testpak
  - id: time.rebase-morphism
    challenge_kind: runtime-positive
    green: owed — the rebase and narrowing arithmetic land with implementation
    red: owed-to-testpak
```
