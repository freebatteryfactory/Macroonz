...
//! digest mechanism (pending mechanism admission). This home owns the identity
//! law and the diagnostic epistemic posture; it never co-owns any family's
//! meanings.
//!
