# Compiler host controls

These controls execute installed Rust tools and independently authored native subjects through the optional root compiler entrance.
Literal diagnostic coordinates, read-back expectations and hostile tool output are authored here without calling the production extractor to construct an expectation.
Disposable fixtures use the existing native-policy scratch owner and ordinary Cargo target.
